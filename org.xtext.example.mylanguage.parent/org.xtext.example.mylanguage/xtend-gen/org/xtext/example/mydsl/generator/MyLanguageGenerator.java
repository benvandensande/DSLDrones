  ...
  public CharSequence createRunStat(final RobotPositionSent body) {
    CharSequence _xblockexpression = null;
    {
      ...
      if (_equals) {
        ...
        DistanceUnit _posX = body.getPosX();
        CharSequence _createRunStat = this.createRunStat(_posX);
        _builder.append(_createRunStat, "");
        _builder.append(", ");
        DistanceUnit _posY = body.getPosY();
        CharSequence _createRunStat_1 = this.createRunStat(_posY);
        _builder.append(_createRunStat_1, "");
        _builder.append(" , ");
        DistanceUnit _posZ = body.getPosZ();
        CharSequence _createRunStat_2 = this.createRunStat(_posZ);
        _builder.append(_createRunStat_2, "");
        ...
        CharSequence _xblockexpression_1 = null;
        {
          ...
          if (sent instanceof CirclePosition) {
            if ((sent instanceof CirclePosition)) {
              ...
              DistanceUnit _posX_1 = body.getPosX();
              CharSequence _createRunStat_3 = this.createRunStat(_posX_1);
              _builder_1.append(_createRunStat_3, "");
              _builder_1.append(", ");
              DistanceUnit _posY_1 = body.getPosY();
              CharSequence _createRunStat_4 = this.createRunStat(_posY_1);
              _builder_1.append(_createRunStat_4, "");
              _builder_1.append(" , ");
              DistanceUnit _posZ_1 = body.getPosZ();
              CharSequence _createRunStat_5 = this.createRunStat(_posZ_1);
              _builder_1.append(_createRunStat_5, "");
              _builder_1.append(", ");
              CharSequence _createRunStat_6 = this.createRunStat(((CirclePosition)sent));
              _builder_1.append(_createRunStat_6, "");
          ...
          if (!_matched) {
            if (sent instanceof SpherePosition) {
              if ((sent instanceof SpherePosition)) {
                ...
                _builder_1.append(_createRunStat_5, "");
                _builder_1.append(", ");
                CharSequence _createRunStat_6 = this.createRunStat(((SpherePosition)sent));
                _builder_1.append(_createRunStat_6, "");
                _builder_1.append(", this.app, this.drone)");
                _switchResult = _builder_1;
              }
    ...
    CharSequence _xblockexpression = null;
    {
      ...
      if (body instanceof EqualSent) {
        if ((body instanceof EqualSent)) {
          ...
          DistanceUnit _posX = sent.getPosX();
          CharSequence _createRunStat = this.createRunStat(_posX);
          _builder.append(_createRunStat, "");
          _builder.append(", ");
          DistanceUnit _posY = sent.getPosY();
          CharSequence _createRunStat_1 = this.createRunStat(_posY);
          _builder.append(_createRunStat_1, "");
          _builder.append(", ");
          DistanceUnit _posZ = sent.getPosZ();
          CharSequence _createRunStat_2 = this.createRunStat(_posZ);
          _builder.append(_createRunStat_2, "");
          _builder.append(",");
          CharSequence _createRunStat_3 = this.createRunStat(((EqualSent)body));
          _builder.append(_createRunStat_3, "");
          _builder.append(" , this.app, this.drone)");
          _switchResult = _builder;
        }
      }
      if (!_matched) {
        if (body instanceof GreaterSent) {
          if ((body instanceof GreaterSent)) {
            ...
            _builder.append(_createRunStat_2, "");
            _builder.append(",");
            CharSequence _createRunStat_3 = this.createRunStat(((GreaterSent)body));
            _builder.append(_createRunStat_3, "");
            _builder.append(" , this.app, this.drone)");
            _switchResult = _builder;
          }
      ...
      if (!_matched) {
        if (body instanceof LessSent) {
          if ((body instanceof LessSent)) {
            ...
            _builder.append(_createRunStat_2, "");
            _builder.append(",");
            CharSequence _createRunStat_3 = this.createRunStat(((LessSent)body));
            _builder.append(_createRunStat_3, "");
            _builder.append(" , this.app, this.drone)");
            _switchResult = _builder;
          }
  ...
  public CharSequence createRunStat(final GPSReadingSent s) {
    CharSequence _xblockexpression = null;
    {
      ...
      if (_equals) {
        ...
        DistanceUnit _posX = s.getPosX();
        CharSequence _createRunStat = this.createRunStat(_posX);
        _builder.append(_createRunStat, "");
        _builder.append(", ");
        DistanceUnit _posY = s.getPosY();
        CharSequence _createRunStat_1 = this.createRunStat(_posY);
        _builder.append(_createRunStat_1, "");
        _builder.append(" , ");
        DistanceUnit _posZ = s.getPosZ();
        CharSequence _createRunStat_2 = this.createRunStat(_posZ);
        _builder.append(_createRunStat_2, "");
        _builder.append(", new SpherePosition(new Meter(0)), this.app , this.drone)");
        _xifexpression = _builder;
        ...
        CharSequence _xblockexpression_1 = null;
        {
          ...
          if (sent instanceof CirclePosition) {
            if ((sent instanceof CirclePosition)) {
              ...
              DistanceUnit _posX_1 = s.getPosX();
              CharSequence _createRunStat_3 = this.createRunStat(_posX_1);
              _builder_1.append(_createRunStat_3, "");
              _builder_1.append(", ");
              DistanceUnit _posY_1 = s.getPosY();
              CharSequence _createRunStat_4 = this.createRunStat(_posY_1);
              _builder_1.append(_createRunStat_4, "");
              _builder_1.append(" , ");
              DistanceUnit _posZ_1 = s.getPosZ();
              CharSequence _createRunStat_5 = this.createRunStat(_posZ_1);
              _builder_1.append(_createRunStat_5, "");
              _builder_1.append(", ");
              CharSequence _createRunStat_6 = this.createRunStat(((CirclePosition)sent));
